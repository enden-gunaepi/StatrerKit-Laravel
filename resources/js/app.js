(function () {
    ...
    function twoColumnMenuGenerate() {
        ...
        if (
            ...
            ul.innerHTML =
                '<a href="index" class="logo"><img src="build/images/logoipsum-282.svg" alt="" height="22"></a>';
            Array.from(
                document
    ...
    function layoutSwitch(isLayoutAttributes) {
        // console.log("isLayoutAttributes", isLayoutAttributes);
    ...
    function setLayoutMode(mode, modeType, modeTypeId, html) {
        ...
        if (isModeTypeId) {
            ...
            // if (modeType == "light")
            // 	modeType = "dark"
            if (modeType == "dark") modeType = "dark";
