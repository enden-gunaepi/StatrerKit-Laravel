<button class="btn btn-ghost-light btn-icon" id="back-to-top">
    <i class="bi bi-arrow-up-circle-fill fs-3xl text-primary rounded-full"></i>
</button>
<!--end back-to-top-->
...
<div class="customizer-setting d-none d-md-block">
    {{-- <div class="btn btn-primary p-2 text-uppercase rounded-end-0 shadow-lg" data-bs-toggle="collapse" data-bs-target="#theme-settings-offcanvas" aria-controls="theme-settings-offcanvas"> --}}
    <div class="btn btn-primary p-2 text-uppercase rounded-end-0 shadow-lg" data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas" aria-controls="theme-settings-offcanvas">
        <i class="bi bi-gear fs-2xl"></i>
    </div>
</div>
...
<div class="offcanvas offcanvas-end border-0" tabindex="1" id="theme-settings-offcanvas">
    <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
        <div class="me-2">
            <h6 class="mb-1 fs-lg text-white">{{ config('app.name')}} Customizer Builder</h6>
    ...
    <div class="offcanvas-body p-0">
        <div data-simplebar class="h-100">
            <div class="p-4">
                <h6 class="fs-md mb-1">Layout Type</h6>
                <p class="text-muted fs-sm">Choose your custom layout</p>
                ...
                <div id="layout-position">
                    <h6 class="mt-4 fs-md mb-1">Navbar Type</h6>
                    <p class="text-muted fs-sm">Choose Fixed Navbar or Static Navbar.</p>
                    ...
                    <div class="btn-group radio" role="group">
                        ...
                        <label class="btn btn-light w-sm ms-0" for="layout-position-scrollable">Static</label>
                    </div>
                </div>

                {{-- <h6 class="mt-4 fs-md mb-1">Navbar Color</h6>
                <p class="text-muted fs-sm">Choose Navbar Color.</p>
                ...
                <div id="sidebar-size">
                    <h6 class="mt-4 fs-md mb-1">Sidebar Type</h6>
                    <p class="text-muted fs-sm">Choose a type of Sidebar.</p>
